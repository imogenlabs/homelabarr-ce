...
> **Generated:** 2026-06-07 06:32 UTC · **Source:** `scripts/generate-whitelabel-audit.sh`
>
...
**Total brand references found:** 1326
...
| `.github/workflows/security-audit.yml` | 285 | `          ghcr.io/smashingtags/homelabarr-frontend:latest` |
| `.github/workflows/security-audit.yml` | 286 | `          ghcr.io/smashingtags/homelabarr-backend:latest` |
| `.github/workflows/security-audit.yml` | 369 | `        if: always() && hashFiles('trivy-results/trivy-ghcr.io_smashingtags_homelabarr-frontend_latest.sarif') != ''` |
| `.github/workflows/security-audit.yml` | 371 | `          sarif_file: 'trivy-results/trivy-ghcr.io_smashingtags_homelabarr-frontend_latest.sarif'` |
| `.github/workflows/security-audit.yml` | 372 | `          category: 'trivy-homelabarr-frontend'` |
| `.github/workflows/security-audit.yml` | 376 | `        if: always() && hashFiles('trivy-results/trivy-ghcr.io_smashingtags_homelabarr-backend_latest.sarif') != ''` |
| `.github/workflows/security-audit.yml` | 378 | `          sarif_file: 'trivy-results/trivy-ghcr.io_smashingtags_homelabarr-backend_latest.sarif'` |
| `.github/workflows/security-audit.yml` | 379 | `          category: 'trivy-homelabarr-backend'` |
...
| `playwright.config.ts` | 66 | `        DB_PATH: path.join(DATA_DIR, 'homelabarr.db'),` |
